	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead"> SIAS TUTORIALS</h1>
			</div>
					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="social-networks">
								<a href="https://www.facebook.com/sayyed.shabaan.1" class="fa fa-facebook"></a>
								<a href="https://twitter.com/Sayedsh85241982" class="fa fa-twitter"></a>
								<a href="https://www.instagram.com/sayyed_shabaan" class="fa fa-instagram"></a>
								<!-- <a href="" class="fa fa-reddit"></a> -->
								<a href="https://www.linkedin.com/in/shabaan-sayed-51513b1a4/"></a>
 ...
 -->
		...
		<section class="header7 cid-rjrjygOfd1" id="header7-3">
			...
			<div class="container text-center" id="our-members">
				<h2><b>MEMBERS</b></h2>
				<p>
					These are our excellent members .You can contact anyone anytime <br> and all are experts and well experienced.
				</p>
			</div>
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/shabaan.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Sayed Shabaan</h4>
							...
							<div class="team-member text-center">
								<img src="img/suzanne.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Suzanne Ansari</h4>
							...
							<div class="team-member text-center">
								<img src="img/ishaque.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Inamdar Ishaque</h4>
									<h4 class="team-member-designation">Sr. Developer</h4>
									<ul class="social-list">
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
							...
							<div class="team-member text-center">
								<img src="img/abdurrazzak.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Abdul Razzak</h4>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												SIAS TUTORIAL is an online E-learning website <br>
